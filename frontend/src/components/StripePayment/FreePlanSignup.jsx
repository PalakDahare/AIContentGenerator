...
import { handleFreeSubscriptionAPI } from "../../api's/stripePayment/stripePayment";
...
const FreePlanSignup = () => {
  ...
  console.log("mutationerhbf", mutation);
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900 flex justify-center items-center p-6">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full">
        ...
        {mutation.isSuccess && (
          <StatusMessage type="success" message="Plaan has been Upgraded." />
        )}
        {mutation.isError && (
          <StatusMessage
            type="error"
